...
readonly QUERY_CMD=(
  bazel query
    ...
    'kind("cc_(library|binary|test|inc_library|proto_library)", //application/adp/activities/road/... + //application/adp/activities/lanes/... + //application/adp/perception/road/... + //application/adp/perception/lanes/... + //application/adp/degradation/... + //application/adp/diagnostic/... + //application/adp/common/...  + //application/adp/map/... + //application/adp/bmw/tools/visualization/roadmodel/... + //application/adp/bmw/reprocessing/... )'
)
